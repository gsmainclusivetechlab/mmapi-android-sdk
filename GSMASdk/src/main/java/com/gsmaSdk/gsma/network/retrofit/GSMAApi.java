...
/****************************************Bill Payments********************************************/
     ...
     * @param apiRequestCallback Listener for api operation
     */
    public void viewBillPayment(String uuid, String accountIdentifier, HashMap<String, String> params,String billReference, APIRequestCallback<BillPayment> apiRequestCallback) {
        headers.put(APIConstants.X_CORRELATION_ID, uuid);
