...
1.Download the file GSMATest-v1.0.9 from the following link into the filemanager of your  device
 
[Download](../release/GSMATest-v1.0.9.apk)


2.Click on the file GSMATest-v1.0.9 from your device and system will ask for the installation dialog and continue the installation process
